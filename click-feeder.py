...
n_senders = 100000          # Number of senders
...
senders = [dispatcher.add_sender(Sender(sender_name, n_queries, n_senders*0.00000001, n_senders*0.00000001)) for sender_name in sender_names]
